...
{{- $maxage := default "12h" $.Values.jfr.maxage }}
{{- $jfcFilePath := default "/opt/harness/profile.jfc" $.Values.jfr.jfcFilePath }}
{{- $maxchunksize := default "20M" $.Values.jfr.maxchunksize }}
{{- $memorysize := default "20M" $.Values.jfr.memorysize }}
